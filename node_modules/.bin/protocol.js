...
$root.msg = (function() {
    ...
    msg.Breath = (function() {
         ...
         * @implements IBreath
         * @constructor
         * @param {msg.IBreath=} [properties] Properties to set
         */
         ...
         * @static
         * @param {msg.IBreath=} [properties] Properties to set
         * @returns {msg.Breath} Breath instance
         */
         ...
         * @memberof msg.Breath
         * @static
         * @param {msg.IBreath} message Breath message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.Breath} Breath
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Breath.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.msg.Breath();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        Breath.fromObject = function fromObject(object) {
            if (object instanceof $root.msg.Breath)
                return object;
            return new $root.msg.Breath();
        };
         ...
         * @memberof msg.Breath
         * @static
         * @param {msg.Breath} message Breath
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        Breath.toObject = function toObject() {
            return {};
        };
    ...
    msg.UserResult = (function() {
         ...
         * @property {string|null} [msg] UserResult msg
         * @property {number|null} [gold] UserResult gold
         */
    ...
    msg.Person = (function() {
         ...
         * @property {string|null} [Age] Person Age
         * @property {number|null} [Height] Person Height
         */
        ...
        Person.encode = function encode(message, writer) {
            ...
            if (message.Age != null && message.hasOwnProperty("Age"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.Age);
        ...
        Person.fromObject = function fromObject(object) {
            if (object instanceof $root.msg.Person)
                return object;
            var message = new $root.msg.Person();
            if (object.Name != null)
