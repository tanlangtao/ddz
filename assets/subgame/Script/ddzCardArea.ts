...
@ccclass
export default class ddzCardArea extends cc.Component {
    game = null;
    _touchBegan = null;
    _touchMoved = null;
    HandlePoker = null;
    ...
    _getBox(cardArr,index,startindex) {
        var cardPos  = cardArr[index].convertToWorldSpaceAR(cc.v2(-56,-77.7))//转换当前坐标到世界坐标，cc.v2(-56,-77.7)中心点偏移量，左下角
