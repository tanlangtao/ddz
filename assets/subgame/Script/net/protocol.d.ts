...
export namespace msg {
    ...
    class Breath implements IBreath {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: msg.IBreath);
         ...
         */
        public static create(properties?: msg.IBreath): msg.Breath;

        /**
         * Encodes the specified Breath message. Does not implicitly {@link msg.Breath.verify|verify} messages.
         * @param message Breath message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: msg.IBreath, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified Breath message, length delimited. Does not implicitly {@link msg.Breath.verify|verify} messages.
         * @param message Breath message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: msg.IBreath, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): msg.Breath;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): msg.Breath;
         ...
         * @returns Breath
         */
        public static fromObject(object: { [k: string]: any }): msg.Breath;
         ...
         * @returns Plain object
         */
        public static toObject(message: msg.Breath, options?: $protobuf.IConversionOptions): { [k: string]: any };
    ...
    class Person implements IPerson {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: msg.IPerson);
         ...
         */
        public static create(properties?: msg.IPerson): msg.Person;
         ...
         * @returns Writer
         */
        public static encode(message: msg.IPerson, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: msg.IPerson, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): msg.Person;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): msg.Person;
         ...
         * @returns Person
         */
        public static fromObject(object: { [k: string]: any }): msg.Person;
         ...
         * @returns Plain object
         */
        public static toObject(message: msg.Person, options?: $protobuf.IConversionOptions): { [k: string]: any };
